...
class UpdateBuyerAccountInformationPage {
    ...
    public function handleFormSubmission() {
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($updateSuccess) {
                header("Location: homeowner_manage_profile.php");
                exit();
            } else {
    ...
    public function UpdateBuyerAccountInformationUI() {
        ...
        if (!isset($_GET['username'])) {
            header("Location: homeowner_update_profile.php");
            exit();
        }
        ...
        <div class="form-container">
            ...
            <form method="POST" enctype="multipart/form-data">
                ...
                <div class="button-container">
                    <button type="button" onclick="window.location.href='homeowner_manage_profile.php'">Back</button>
